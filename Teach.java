...
class Teacher {
    ...
    String desgination;
    int teacherId;
    public Teacher(String name, String department, String course, String desgination, int
            teacherId) {
        this.name = name;
...
class Professor extends Teacher{
    public Professor(String name, String department, String course, int teacherId){
        super(name, department, course, "Professor", teacherId);
    }
}
class Associate_professor extends Teacher{
    public Associate_professor(String name, String department, String course, int
            teacherId){
        super(name, department, course, "Associate_professor", teacherId);
    }
}
class Assistant_professor extends Teacher{
    public Assistant_professor(String name, String department, String course, int
            teacherId){
...
public class Teach {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            switch(choice) {
                case 1:
                    Professor prof = new Professor(name, course, department, tid);
                    prof.display();
                    break;
                case 2:
